...
public class UnicodeModul {
	...
	/**
	 * Converts a unicode codepoint to a String.
	 * 
	 * @param cp a valid unicode codepoint (in particular, 0 <= cp <= 0x10FFFD)
	 * @return a String only containing the according character.
	 */
	 ...
	 * @param val >= 0
	 * @param base >= 2
	 * @return the length of val as string in the given base.
	 */
	 ...
	 * @param val >= 0
	 * @param base >= 2
	 * @return the digits of val in the given base.
	 */
	...
	public static void main(String[] arg) throws Exception {
		...
		try {
			...
			f.format("#%n");
			f.format("# This is a autogenerated list of all unicode codepoints (uu0-uu10FFFD),%n");
			f.format("# suitable for appending to the ~/.XCompose file of a GNU/Linux OS.%n");
			f.format("#%n");
			f.format("# Please dont't change it by hand; instead, look at the%n");
			f.format("# Source code: http://github.com/zephyr/java-compose-creator/%n");
			f.format("#%n");
			f.format("# Based on the file: %s%n", filename);
			f.format("# Author: Dennis Heidsiek%n");
			f.format("# Licence (short name): GPL3+%n");
